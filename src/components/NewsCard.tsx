            ...
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between">
              ...
              <div className="mt-3 sm:mt-0 sm:ml-8 flex-shrink-0 flex space-x-2">
                <button
                  ...
                  <div
                    className={`absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 bg-gray-900 text-white text-xs rounded transition-opacity duration-200 pointer-events-none whitespace-nowrap z-50 ${
